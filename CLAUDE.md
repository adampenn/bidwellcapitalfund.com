...
- Assets: `public/chico-avenue/` holds the two photos only. Do not put the deck PDF (or any offering document) in `public/`; it would be reachable without the gate. Docs live in the invportal.
